...
export default function LocationProgramsPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      locationsApi.getPrograms(Number(id)),
    ]).then(([lRes, pRes]) => {
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 20, fontSize: 13 }}>
            ...
            <span style={{ color: 'rgba(255,255,255,0.5)' }}>Địa điểm</span>
            <span style={{ color: 'rgba(255,255,255,0.3)' }}>›</span>
      ...
      <div style={{ maxWidth: 1200, margin: '-40px auto 0', padding: '0 5% 80px' }}>
        <div style={{
          ...
          <span style={{ fontSize: 15, color: 'var(--gray-700)' }}>
            Tất cả chương trình tại <strong>{location?.name}</strong>
          </span>
